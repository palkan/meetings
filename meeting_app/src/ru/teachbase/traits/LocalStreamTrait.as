...
{
import ru.teachbase.manage.streams.events.LocalStreamEvent;
import ru.teachbase.manage.streams.model.LocalStream;
import ru.teachbase.model.Packet;
import ru.teachbase.constants.PacketType;

public class LocalStreamTrait extends RTMPListener
	{
    [Event(name="", type="ru.teachbase.manage.streams.events.LocalStreamEvent")]
