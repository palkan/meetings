...
/**
	 ...
	 */
	public class CircleInstrument extends DrawInstrument
	{
		...
		public function CircleInstrument(tid:String = null)
		{
			super(tid || InstrumentType.CIRCLE);
			strokeStyle.color = 0;
		}
		...
		{
			registerClass(InstrumentType.CIRCLE, CircleInstrument);
		}
