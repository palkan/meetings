 ...
 **/
	 ...
	 * </em>
	 *
	 * @see ru.teachbase.utils.geom.Line
	 * @see ru.teachbase.utils.geom.Intersection
	 *
	 * @langversion 3.0
	 * @playerversion Flash 9.0
	 * 
	...
	public class Bezier extends Object implements IParametric {
		 ...
		 * 
		 * @return ru.teachbase.utils.geom.Bezier copy of the Bezier curve
		 * 
		 ...
		 * 
		 * @return ru.teachbase.utils.geom.Line the line, which is degenerate Bezier curve
		 * 
		 ...
		 * @return ru.teachbase.utils.geom.Intersection объект с описанием пересечения
		 *  
		 * @example <listing version="3.0">
		 *	import flash.geom.Bezier;
		 * 	import flash.geom.Point;
		 ...
		 * 
		 * @return ru.teachbase.utils.geom.Intersection the object with the description of intersection
		 *  
		 * @example <listing version="3.0">
		 *	import flash.geom.Bezier;
		 * 	import flash.geom.Point;
		 ...
		 *   
		 * @param target:Bezier
		 * @return ru.teachbase.utils.geom.Intersection
		 * 
		 * @example <listing version="3.0">
		 *	import flash.geom.Bezier;
		 * 	import flash.geom.Point;
