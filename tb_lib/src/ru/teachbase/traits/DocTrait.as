...
[Event(name="change", type="ru.teachbase.events.DocEvent")]
	[Event(name="state", type="ru.teachbase.events.DocEvent")]
	[Event(name="load", type="ru.teachbase.events.DocEvent")]
	...
	public class DocTrait extends Trait
	{
