...
/**
	...
	public function l(name:String,component:String = "global",...args):String
	{
		return Strings.params_insert((m(LocaleManager) as LocaleManager).getLocaleString(component,name),args);
	}
}