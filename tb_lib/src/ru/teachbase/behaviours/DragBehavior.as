...
[Event(name="dragPrepare", type="ru.teachbase.events.DragEvent")]
	[Event(name="dragStart", type="ru.teachbase.events.DragEvent")]
	[Event(name="dragCancel", type="ru.teachbase.events.DragEvent")]
	[Event(name="dragEnd", type="ru.teachbase.events.DragEvent")]
	[Event(name="dragDrop", type="ru.teachbase.events.DragEvent")]
	...
	public class DragBehavior extends InteractiveBehavior
	{
		...
		protected function startDrag():void
		{
			...
			protected::state = DragState.DRAGGING;
		...
		protected function stopDrag():void
		{
			...
			protected::state = DragState.STATIC;
		...
		public function cancel(returnToStartPosition:Boolean = true):void
		{
			...
			protected::state = DragState.CANCELING;
		...
		protected function moveHandler(e:MouseEvent):void
		{
			...
			if(!_dragging)
			{
				if(_dragPrepareTime !== _prepareDispatchTime)
						protected::state = DragState.PREPARING,
			...
			if(!_dragging)
			{
				...
				const isStartValide:Boolean = DragDirection.collisionAB(this.startDirection, startDirection);
