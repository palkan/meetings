...
/**
	...
	public class Service implements IService
	{
		...
		protected var _client:ClientProxy;
		...
		protected function onConnectionComplete(event:ConnectionFactoryEvent):void
		{
			...
			connection.client = _client = new ClientProxy(this);
		 ...
		 * 
		 */		
		public function incomingCall(name:*, ...rest:Array):*
		{
			
			rest.unshift(name);
			
			return App.traitManager.inputCall.apply(null, rest);
		}
		
		public function output(p:Packet):void
		{
			connection.call('send_message', new Responder(sendResult, sendError), _token, p);
		...
		public function outputCall(method:*, responder:IResponder, rest:Array):void
		{
			rest.unshift('send_method', (responder ? new Responder(sendResult, sendError) : null), _token, method);
			connection.call.apply(null, rest);
